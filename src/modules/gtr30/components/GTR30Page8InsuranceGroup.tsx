...
export const GTR30Page8InsuranceGroup: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className="gtr30-page gtr30-landscape" id="gtr30-page-8">
      <div style={{ maxWidth: '880px', margin: '0 auto', fontSize: '9pt', lineHeight: 1.35, paddingTop: '15px' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '9pt', marginTop: '6px' }}>
          <thead>
            <tr style={{ background: '#f5f5f5', textAlign: 'center', fontFamily: "'Noto Serif Gujarati', serif", fontWeight: 700 }}>
              ...
              <th style={{ border: '1px solid #000', padding: '4px 4px' }} colSpan={2}>જૂથ હેઠળના કર્મચારીઓની સંખ્યા</th>
              <th style={{ border: '1px solid #000', padding: '6px 4px', width: '100px' }} rowSpan={2}>વીમા ફંડમાં<br />ફાળો<br />(રૂ.)</th>
              <th style={{ border: '1px solid #000', padding: '6px 4px', width: '100px' }} rowSpan={2}>બચત ફંડમાં<br />ફાળો<br />(રૂ.)</th>
            ...
            <tr style={{ background: '#f5f5f5', textAlign: 'center', fontFamily: "'Noto Serif Gujarati', serif", fontWeight: 700 }}>
              ...
              <th style={{ border: '1px solid #000', padding: '4px 4px', width: '140px' }}>
        ...
        {/* Signature Block */}
        <div style={{ marginTop: '75px', textAlign: 'center', fontSize: '9pt', lineHeight: 1.3, width: '360px', marginLeft: 'auto' }}>
