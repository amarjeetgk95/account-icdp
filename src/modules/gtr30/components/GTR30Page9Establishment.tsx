  ...
  return (
    <div className="gtr30-page gtr30-landscape" id="gtr30-page-9">
      <div style={{ maxWidth: '880px', margin: '0 auto', fontSize: '9pt', lineHeight: 1.35, fontFamily: "'Noto Serif Gujarati', serif", paddingTop: '20px' }}>
        ...
        {/* Signature Block — refined, consistent Gujarati + English */}
        <div style={{ marginTop: '48px', textAlign: 'center', fontSize: '9pt', lineHeight: 1.35, width: '360px', marginLeft: 'auto', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '12px 10px', background: '#f8fafc', fontFamily: "'Times New Roman', serif" }}>
