  ...
  return (
    <div className="gtr30-page gtr30-portrait" id="gtr30-page-5">
      <div style={{ maxWidth: '780px', margin: '0 auto', fontSize: '9pt', lineHeight: 1.3 }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '8.5pt', marginTop: '6px' }}>
          <thead>
            <tr style={{ background: '#f5f5f5', textAlign: 'center', fontFamily: "'Noto Serif Gujarati', serif", fontWeight: 700 }}>
              ...
              <th style={{ border: '1px solid #000', padding: '5px 4px', width: '85px' }}>મૂળ પગાર</th>
              <th style={{ border: '1px solid #000', padding: '5px 4px', width: '95px' }}>કપાત કરેલ<br />ઘરભાડાની રકમ</th>
            ...
            {employees.length === 0 ? (
              ...
              employees.map((emp, idx) => (
                <tr key={emp.id || idx} style={{ verticalAlign: 'middle' }}>
                  ...
                  <td style={{ border: '1px solid #000', padding: '6px 4px', fontSize: '8pt', lineHeight: 1.25 }}>
        ...
        {/* Amount in words */}
        <div style={{ textAlign: 'center', fontWeight: 700, fontSize: '9.5pt', marginTop: '10px' }}>
