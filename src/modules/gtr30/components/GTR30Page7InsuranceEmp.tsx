        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '8.5pt', marginTop: '6px' }}>
          <thead>
            <tr style={{ background: '#ffffff', textAlign: 'center', fontFamily: "'Noto Serif Gujarati', serif", fontWeight: 700 }}>
              ...
              <th style={{ border: '1px solid #000', padding: '6px 4px', width: '160px', verticalAlign: 'middle' }}>અધિકારી/<br />કર્મચારીનું નામ</th>
              <th style={{ border: '1px solid #000', padding: '6px 4px', width: '130px', verticalAlign: 'middle' }}>હોદ્દો</th>
              <th style={{ border: '1px solid #000', padding: '6px 4px', width: '80px', verticalAlign: 'middle' }}>જૂથ<br />(નવા દર મુજબ)</th>
              <th style={{ border: '1px solid #000', padding: 0, width: '180px', verticalAlign: 'top' }} colSpan={2}>
                <div style={{ borderBottom: '1px solid #000', padding: '3px 4px', fontWeight: 700 }}>જૂથ વીમા કપાત</div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
                  <div style={{ borderRight: '1px solid #000', padding: '3px 2px', fontWeight: 700 }}>વીમા ફંડ<br />(રૂ.)</div>
                  <div style={{ padding: '3px 2px', fontWeight: 700 }}>બચત ફંડ<br />(રૂ.)</div>
                </div>
              </th>
