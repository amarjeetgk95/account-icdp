...
export const DEFAULT_COMPONENT_SEED: DefaultComponentSeed[] = [
  ...
  },
  {
    ...
    headerAliases: [
      ...
      'Pay Arrears',
      'ROP Arrears',
      'ROP Arrears Gaz (0117)',
      'ROP Arrears Non-Gaz (0118)',
      'ROP Arrears (0117)',
      'ROP Arrears (0118)',
      'Pay Revision Arrears',
      'Pay Fixation Arrears',
    ],
    codeAliases: ['0117', '0118'],
    notes: 'Pay difference / ROP arrears.',
  },
  {
    componentCode: '0103',
    componentName: 'DA',
  ...
  {
    componentCode: '0103-DIFF',
    componentName: 'DA Difference',
    shortName: 'DA Diff',
    type: 'EARNING',
    kind: 'COMPONENT',
    category: 'Arrears',
    ...
    codeAliases: ['0103-DIFF', '0103D'],
    notes: 'DA rate revision arrears / difference.',
  },
  {
    componentCode: '0110',
    componentName: 'HRA',
