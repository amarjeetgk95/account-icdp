  ...
  const updateBill = useUpdateGTR44Bill();
   ...
   const handleSubmit = async (formData: GTR44FormData) => {
     try {
       ...
       const billData: Partial<GTR44Bill> = formDataToBill(formData);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-4">
      <WorkspaceHeader
        ...
        actions={
          <Button variant="ghost" size="sm" onClick={() => navigate('/gtr44/list')}>
            <ChevronLeft className="mr-1 h-4 w-4" /> Back to register
          </Button>
        }
      />
