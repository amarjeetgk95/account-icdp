-- 031_establishment_headquarter.sql
-- Store an employee's headquarter/posting designation separately from the
-- sanctioned-post catalogue.

ALTER TABLE public.establishment_employees
  ADD COLUMN IF NOT EXISTS headquarter TEXT;
